...
public class CreateThingDefCommandHandler : IRequestHandler<CreateThingDefCommand, ThingDefDto>
{
    ...
    public async Task<ThingDefDto> Handle(CreateThingDefCommand request, CancellationToken cancellationToken)
    {
