        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ThingDefs_PropertyDef_PropertyDef4Id",
                        column: x => x.PropertyDef4Id,
                        principalTable: "PropertyDef",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ThingDefs_PropertyDef_PropertyDef5Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThingDefId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ThingDefs_PropertyDef4Id",
                table: "ThingDefs",
                column: "PropertyDef4Id");

            migrationBuilder.CreateIndex(
                name: "IX_ThingDefs_PropertyDef5Id",
                table: "ThingDefs",
