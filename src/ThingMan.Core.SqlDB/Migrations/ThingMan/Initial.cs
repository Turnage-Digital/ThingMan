    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    ...
                    "Id");
                table.ForeignKey(
                    "FK_ThingDefs_PropertyDef_PropertyDef4Id",
                    x => x.PropertyDef4Id,
                    "PropertyDef",
                    "Id");
                table.ForeignKey(
                    "FK_ThingDefs_PropertyDef_PropertyDef5Id",
                    x => x.PropertyDef5Id,
                    "PropertyDef",
                    "Id");
            });
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                ThingDefId = table.Column<Guid>("TEXT", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateIndex(
            "IX_ThingDefs_PropertyDef4Id",
            "ThingDefs",
            "PropertyDef4Id");

        migrationBuilder.CreateIndex(
            "IX_ThingDefs_PropertyDef5Id",
            "ThingDefs",
            "PropertyDef5Id");
    }
